    ...
    <div className="over-stage mt-14 flex flex-wrap items-start gap-x-5 gap-y-6 sm:gap-x-8">
      {RULE.map((part, i) => (
        <motion.div
          ...
          initial={reduced ? { opacity: 0 } : { opacity: 0, y: 24, scale: 0.86 }}
          ...
          <span
            className={[
              ...
              part.operator
                ...
                : "text-[clamp(52px,7vw,92px)]",
              part.accent ? "spectrum-text" : "text-ink",
            ].join(" ")}
          >
            {part.glyph}
          </span>
    ...
    <Beat index={2} id="delivery">
      <div className="relative max-w-2xl md:ml-auto md:max-w-[60%]">
        ...
        <h2 className="display over-stage mt-8">
          ...
          <Reveal delay={0.21}>
            <span className="spectrum-text">delivered.</span>
          </Reveal>
        </h2>
